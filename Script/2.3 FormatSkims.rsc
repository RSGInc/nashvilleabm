 ...
 */
                ...
                if (Modes[imode]="Brt") then do
                  ...
                  mc22 := if ((mc19 + mc20) <= 0) then 0 else (mc22)    // for DaySim - as only commuter rail ivt is provided in the roster, therefore, this core should also include commuter rail shuttle.
...
*/              end
                ...
                if (Modes[imode]="ComRail") then do
                  ...
                  mc17 := if ((mc22) <= 0) then 0 else (mc17 + mc18)
                  ...
                  mc24 := if ((mc22) <= 0) then 0 else mc24
				          mc25 := if ((mc22) <= 0) then 0 else mc25
