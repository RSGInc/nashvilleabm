...
Macro "Highway Skimming" (Args)    // Highway Skimming
   ...
   if !ret_value then goto quit 
	...
	CreateMatrix({tazname +"|", tazname  + ".ID","TAZ_ID"},{tazname +"|", tazname  + ".ID","TAZ_ID"}, // TC9: ID; TC8: ID_NEW
	...
	for i=1 to terminal.length do 
		...
		Opts.Input.[Old ID Field] = {taz_db+"|"+tazname, "ID"} // TC9: ID; TC8: ID_NEW
		Opts.Input.[New ID Field] = {taz_db+"|"+tazname, "ID"} // TC9: ID; TC8: ID_NEW
...
Shared Scen_Dir  	
    ...
    Opts.Input.[Source Currencies] = {{Scen_Dir +  "outputs\\ExtDistSkims.mtx", "EE - Length", "Origin", "Destination"}} // TC8:"EE - Length"; TC9: "Length"
