...
dshhfile                                  = "../DaySim/configuration_regress_outputs/_household.tsv"
dsperfile                                 = "../DaySim/configuration_regress_outputs/_person.tsv"
dspdayfile                                = "../DaySim/configuration_regress_outputs/_person_day.tsv"
dstourfile                                = "../DaySim/configuration_regress_outputs/_tour.tsv"
dstripfile                                = "../DaySim/configuration_regress_outputs/_trip.tsv"
dstriplistfile                            = "../DaySim/configuration_regress_outputs/Tdm_trip_list.csv"
